...
class StripPooling(nn.Module):
    def __init__(self, in_channels, pool_size, norm_layer=nn.BatchNorm2d, up_kwargs={'mode': 'bilinear', 'align_corners': True}):
...
class SPHead(nn.Module):
    def __init__(self, in_channels, out_channels, norm_layer=nn.BatchNorm2d, up_kwargs={'mode': 'bilinear', 'align_corners': True}):
...
if __name__ == "__main__":
    in_tensor =torch.randn(8, 64, 160, 160)

    module = SPHead(64, 128)
