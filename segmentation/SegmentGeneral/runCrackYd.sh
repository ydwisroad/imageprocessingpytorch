python train.py --config=configsYd/crack_unet_crossentr.json
python train.py --config=configsYd/crack_unet_bce.json
python train.py --config=configsYd/crack_unet_dice.json
...
python train.py --config=configsYd/crack_linknet_crossentr.json
python train.py --config=configsYd/crack_linknet_bce.json
python train.py --config=configsYd/crack_linknet_dice.json
python train.py --config=configsYd/crack_gcn_crossentr.json
python train.py --config=configsYd/crack_gcn_bce.json
python train.py --config=configsYd/crack_gcn_dice.json
...
python train.py --config=configsYd/crack_fcn_crossentr.json
python train.py --config=configsYd/crack_fcn_bce.json
python train.py --config=configsYd/crack_fcn_dice.json
python train.py --config=configsYd/crack_exfuse_crossentr.json
python train.py --config=configsYd/crack_exfuse_bce.json
python train.py --config=configsYd/crack_exfuse_dice.json
python train.py --config=configsYd/crack_enet_crossentr.json
