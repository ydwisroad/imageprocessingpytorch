...
def main(args=None):
    ...
    parser.add_argument('--csv_train', help='Path to file containing training annotations (see readme)', default="train.csv")
    parser.add_argument('--csv_classes', help='Path to file containing class list (see readme)', default="./classes.txt")
    parser.add_argument('--csv_val', help='Path to file containing validation annotations (optional, see readme)', default="train.csv")

    parser.add_argument('--depth', help='Resnet depth, must be one of 18, 34, 50, 101, 152', type=int, default=34)
    parser.add_argument('--epochs', help='Number of epochs', type=int, default=3)
    parser.add_argument('--batch_size', help='batch_size', type=int, default=6)
    ...
    for epoch_num in range(parser.epochs):
        ...
        print("mAP ", mAP, " epoch_num ", epoch_num)
        if (mAP > bestMap):
            bestMap = mAP
