...
ap.add_argument('-w', '--weights', type=str, default='logs/coco2017/efficientdet-d0_1_12.pth', help='/path/to/weights')
...
weights_path = f'weights/efficientdet-d0_0_6.pth' if args.weights is None else args.weights
...
if __name__ == '__main__':
    ...
    VAL_GT = f'/Users/i052090/Downloads/segmentation/data/{params["project_name"]}/annotations/instances_{SET_NAME}.json'
    VAL_IMGS = f'/Users/i052090/Downloads/segmentation/data/{params["project_name"]}/images/{SET_NAME}/'
    print("Coco ", VAL_GT, " VAL_IMGS ", VAL_IMGS)
    MAX_IMAGES = 10000
    coco_gt = COCO(VAL_GT)
