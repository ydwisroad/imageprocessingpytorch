...
class LoadImagesAndLabels(Dataset):  # for training/testing
    def __init__(self, path, img_size=640, batch_size=16, augment=False, hyp=None, rect=False, image_weights=False,
        ...
        # print("cache ", cache)
        # print("os sep ", os.sep)
        # print("image files ", self.img_files)
        imagesfilesnew = [c.replace('/', '\\') for c in self.img_files]
        # print("imagesFilesNew ", imagesfilesnew)

        # Get labels
        # labels, shapes = zip(*[cache[x] for x in self.img_files])
        labels, shapes = zip(*[cache[x] for x in imagesfilesnew])
