...
class SlimConv3x3(nn.Module):

    def __init__(self, in_planes, stride = 1, groups=1, dilation=1):
        super(SlimConv3x3, self).__init__()
        self.stride = stride
...
if __name__ == '__main__':
    slimConv = SlimConv3x3(64)

    import torch

    testx1 = torch.randn(8, 64, 160, 160)

    print("slimConv input shape ", testx1.shape)
    output = slimConv(testx1)
    print("slimConv output shape ", output.shape)
