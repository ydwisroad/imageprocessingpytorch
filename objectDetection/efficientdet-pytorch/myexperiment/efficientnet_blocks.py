...
class ConvBnAct(nn.Module):
    ...
    def __init__(
        ...
        self.conv = nn.Conv2d(in_chs, out_chs, kernel_size, stride=stride, dilation=dilation)
        #create_conv2d(in_chs, out_chs, kernel_size, stride=stride, dilation=dilation, padding=pad_type)
...
class DepthwiseSeparableConv(nn.Module):
    ...
    def __init__(
        ...
        self.conv_dw =  nn.Conv2d(in_chs, out_chs, dw_kernel_size, stride=stride, dilation=dilation)
        #create_conv2d(
        ...
        self.conv_pw = nn.Conv2d(in_chs, out_chs, pw_kernel_size, stride=stride, dilation=dilation)
        #create_conv2d(in_chs, out_chs, pw_kernel_size, padding=pad_type)
...
class InvertedResidual(nn.Module):
    ...
    def __init__(
        ...
        self.conv_pw = nn.Conv2d(in_chs, mid_chs, exp_kernel_size, stride=stride, dilation=dilation)
        #create_conv2d(in_chs, mid_chs, exp_kernel_size, padding=pad_type, **conv_kwargs)
        self.bn1 = norm_layer(mid_chs)
        self.act1 = act_layer(inplace=True)

        # Depth-wise convolution
        self.conv_dw = nn.Conv2d(in_chs, mid_chs, dw_kernel_size, stride=stride, dilation=dilation)
            #create_conv2d(
        ...
        self.conv_pwl = nn.Conv2d(mid_chs, out_chs, pw_kernel_size, stride=stride, dilation=dilation)
        #create_conv2d(mid_chs, out_chs, pw_kernel_size, padding=pad_type, **conv_kwargs)
...
class EdgeResidual(nn.Module):
    ...
    def __init__(
        ...
        self.conv_exp = nn.Conv2d(in_chs, mid_chs, exp_kernel_size, stride=stride, dilation=dilation)
        #create_conv2d(in_chs, mid_chs, exp_kernel_size, stride=stride, dilation=dilation, padding=pad_type)
        self.bn1 = norm_layer(mid_chs)
        self.act1 = act_layer(inplace=True)
        ...
        # Point-wise linear projection
        self.conv_pwl = nn.Conv2d(mid_chs, out_chs, pw_kernel_size, stride=stride, dilation=dilation)
        #create_conv2d(mid_chs, out_chs, pw_kernel_size, padding=pad_type)
        self.bn2 = norm_layer(out_chs)
