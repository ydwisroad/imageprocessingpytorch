...
def make_data(sentences):
    ...
    tensorEncInput, tensorDecInput, tensorDecOutput=torch.LongTensor(enc_inputs), torch.LongTensor(dec_inputs), torch.LongTensor(dec_outputs)
    return tensorEncInput, tensorDecInput, tensorDecOutput


enc_inputs, dec_inputs, dec_outputs = make_data(sentences)
print("make_data as below ")
